...
Do rozpoznawania zapisu nutowego z obrazu i PDF właściwym narzędziem jest Audiveris, które produkuje MusicXML i wymaga Javy. Zwykły OCR tekstowy na nutach da wynik bezużyteczny. Materiał nutowy w obrazie lub PDF, wskazany flagą `--nuty`, jest do czasu wdrożenia Audiverisa kontrolowanie pomijany z czytelnym komunikatem. Cała ta ścieżka, wraz z Audiverisem, dochodzi w drugiej części etapu dziesiątego. Audiveris jest opcjonalny, a jego brak wyłącza tylko rozpoznawanie notacji z obrazów.
