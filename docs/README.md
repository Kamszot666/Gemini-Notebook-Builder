...
1. `INSTALL.md` — przygotowanie Pythona i środowiska wirtualnego, instalacja
   ...
   błędny, oraz pierwsze pobranie modelu transkrypcji Whisper. Instrukcje pod
   obsługę klawiaturą i czytnik ekranu NVDA.
2. `ARCHITECTURE.md` — podział na moduły i przebieg potoku przetwarzania, wraz
   ...
   fazą pakowania, fazą OCR, fazą transkrypcji, migracją schematu checkpointu,
   pakietem obrazów, pakietem audio oraz pakietem interfejsu WWW.
...
4. `FORMATS.md` — obsługiwane wejścia, w tym adresy stron internetowych i filmów
   z serwisu YouTube, formaty dokumentowe i biurowe oraz archiwa ZIP, obrazy, OCR skanowanego PDF, nagrania
...
6. `TROUBLESHOOTING.md` — objaw, przyczyna i sposób postępowania dla problemów
   ...
   bez aktywnego środowiska wirtualnego, wznowienia projektu, plików wynikowych
